...
EXPECTED_PAGE_PACKING_CONFIG="gemmini-a${GGML_GEMMINI_PAGE_PACKED_A:-0}-b${GGML_GEMMINI_PAGE_PACKED_B:-1}-c${GGML_GEMMINI_PAGE_PACKED_C:-0}-d${GGML_GEMMINI_PAGE_PACKED_D:-0}"
