    ...
    val gemmini_3 = (p: Parameters) => {
      ...
      InModuleBody {
        ...
        if (gemmini0.config.use_shared_res_entries) {
          ...
          require(gemmini0.config.reservation_station_entries_ex == gemmini1.config.reservation_station_entries_ex && gemmini2.config.reservation_station_entries_ex == gemmini3.config.reservation_station_entries_ex && gemmini0.config.reservation_station_entries_ex == gemmini2.config.reservation_station_entries_ex)
          require(gemmini0.config.reservation_station_entries_st == gemmini1.config.reservation_station_entries_st && gemmini2.config.reservation_station_entries_st == gemmini3.config.reservation_station_entries_st && gemmini0.config.reservation_station_entries_st == gemmini2.config.reservation_station_entries_st)
